...
public class GoldstandardGUI extends CustomComponent {
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(textField_label, "top:316.0px;left:240.0px;");
		...
		mainLayout.addComponent(textField_type, "top:316.0px;left:420.0px;");
		...
		mainLayout.addComponent(label_label, "top:298.0px;left:240.0px;");
		...
		mainLayout.addComponent(label_type, "top:298.0px;left:420.0px;");
		
		// label_sentence2
		label_sentence2 = new Label();
		label_sentence2.setImmediate(false);
		label_sentence2.setWidth("-1px");
		label_sentence2.setHeight("-1px");
		label_sentence2.setValue("Sentence:");
		mainLayout.addComponent(label_sentence2, "top:200.0px;left:240.0px;");
