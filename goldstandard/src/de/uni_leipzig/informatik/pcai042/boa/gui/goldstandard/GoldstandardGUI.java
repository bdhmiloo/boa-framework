...
public class GoldstandardGUI extends CustomComponent
{
	...
	private AbsoluteLayout buildMainLayout()
	{
		...
		buttonDiscard.setImmediate(false);
		...
		buttonAddAnno.setImmediate(false);
		buttonAddAnno.setWidth("-1px");
		buttonAddAnno.setHeight("-1px");
		mainLayout.addComponent(buttonAddAnno, "top:180.0px;left:190.0px;");
		
		// buttonDelAnno
		buttonDelAnno = new Button();
		buttonDelAnno.setCaption("delete");
		buttonDelAnno.setImmediate(false);
		...
		textFieldLabel.setWidth("239px");
		textFieldLabel.setHeight("-1px");
		textFieldLabel.setSecret(false);
		mainLayout.addComponent(textFieldLabel, "top:206.0px;left:1.0px;");
		...
		listSelectAnnotations.setWidth("241px");
		listSelectAnnotations.setHeight("87px");
		mainLayout.addComponent(listSelectAnnotations, "top:206.0px;left:260.0px;");
		...
		mainLayout.addComponent(labelAnnotations, "top:182.0px;left:260.0px;");
